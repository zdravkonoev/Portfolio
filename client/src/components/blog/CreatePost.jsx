...
export default function CreatePost() {
    ...
    const createPostHandler = async (values) => {
        ...
        formData.author = {
            ...
            href: '#',
            imageUrl: values.authorImage === "" ? user?.picture : values.authorImage,
        };
        ...
        try {
            ...
            const result = await request('/data/posts', 'POST', formData, { accessToken: user?.accessToken });// , {accessToken: user?.accessToken}
